...
func TestAddValuesToExecuteFrame_NoReplacedTerms(t *testing.T) {
	...
	prepareRequestInfo := NewPrepareRequestInfo(NewGenericRequestInfo(forwardToBoth, false, true), false, []*term{}, false, "", "", "")
...
func TestAddValuesToExecuteFrame_PositionalValues(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			prepareRequestInfo := NewPrepareRequestInfo(NewGenericRequestInfo(forwardToBoth, false, true), false, replacedTerms, containsPositionalMarkers, "", "", "")
...
func TestAddValuesToExecuteFrame_NamedValues(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			prepareRequestInfo := NewPrepareRequestInfo(NewGenericRequestInfo(forwardToBoth, false, true), false, replacedTerms, false, "", "", "")
